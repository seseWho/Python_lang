...
# Unlike many languages, Python can compare two tuples in the same way you compare numbers.
if(sys.version_info< (3,5)):
    print("This game requires at least version 3.5 of Python. Please download from www.python.org")
    sys.exit()
